...
public class deathDays : MonoBehaviour
{
    ...
    public void changeDeathPosition()
    {
        ...
        {
            Origin = GameObject.Find("Deathcircle0");

            point = GameObject.Find("Deathcircle" + i);
    ...
    public void createCircle(Vector2 anchoredPosition)
    {
        ...
        GameObject circle = new GameObject("Deathcircle" + circleNum, typeof(Image)); //creats point
        circleNum++;
